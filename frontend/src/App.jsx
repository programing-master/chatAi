        ...
        <div className='flex flex-col min-h-screen md:flex-row w-full gap-2 p-1 bg-gradient-to-b from-black  to-dark-onPrimary'>
          ...
          <div className='chat-container flexflex-col gap-20 w-full'>
            ...
            >
              ...
              <button
                type='submit'
                className='bg-transparent rounded-full w-[23%] md:w-[10%] flex items-center gap-2 justify-center border bg-light-surfaceTint transition hover:border-light-surfaceTint/30'
              >
                Send
                <IoIosSend />
              </button>
